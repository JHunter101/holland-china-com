...
function renderPosts(type: 'news' | 'events', containerId: string, allowed: number) {
...
function createPostElement(post: any, type: 'news' | 'events', pid: string): HTMLElement | null {
